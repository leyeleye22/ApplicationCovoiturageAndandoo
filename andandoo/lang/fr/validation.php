...
return [
    ...
    */
    ...
    'alpha_dash' => 'Le champ :attribute ne peut contenir que des lettres,
    ...
    'password' => [
        ...
        'uncompromised' => 'Le :attribute donné est apparu dans une fuite de données.
        Veuillez choisir un autre :attribute.',
    ],
    ...
    | spécifier rapidement un message de langue spécifique pour une règle d'attribut donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour échanger nos attributs de substitution
    | avec quelque chose de plus convivial pour le lecteur comme "Adresse e-mail" au lieu
